 ...
 */
public class PostgresJsonSQL93Dialect extends PostgreSQL94Dialect {

	public PostgresJsonSQL93Dialect() {
		...
		registerFunction("internal_json_text_default", new SQLFunctionTemplate(StringType.INSTANCE, "?1#>>?2"));
	}
}
